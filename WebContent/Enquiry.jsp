...
<div class="header1">
		...
		<a href="#" style="border:none;">BOOKING STATUS </a> <a href="#">CANCELLATION </a> <a
			href="Enquiry.jsp" style="color:#5695e0">ENQUERY </a>
	</div>
	<div class="header2">


		<a href="Faq.jsp">FAQ </a> <a href="ContactUs.jsp" >CONTACT US </a> <a href="Tariffs.jsp">TARIFFS
		</a> <a href="Gallery.jsp">GALLERY</a> <a href="Service.jsp">SERVICES </a> <a href="BookCab.jsp">BOOK
