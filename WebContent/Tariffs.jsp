...
<title>Tariffs | Fare Chart for Mini,Macro,Prime</title>
</head>
<body bgcolor="#ccc">
...
<div class="header1">
    ...
    <tr>
    <td style="color:#5695e0;">LOCATION:</td>
    <td colspan="5">
          <div data-select-box>
    <select id="myList">
    ...
    <td>Wait Time Charges</td>
    <td>Ride Time Charges</td>
    </tr>
    
    <tr>
    
    <td>Mini**</td>
    <td>Rs 99 for first 4 Km</td>
    <td>Rs 7 per Km</td>
    <td>N/A</td> 
    <td>Rs 1 per Min</td>
    ...
    <p>* Wait time includes time taken to board the cab after pickup time as well as waiting during the trip.<br>
* Ride time includes total time from the pickup time to drop time.<br>
* Wait time is chargeable.</p>
    ...
    <td>Service Tax**</td>
    <td>Additional Service tax would be applicable on the bill amount.</td>
  
    
    </tr>
    </table>
    
  <p>  * Tolls and tax will be charged as applicable. </p>
